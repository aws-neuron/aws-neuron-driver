...
#define AWS_REG_V2_TDMA_MODEL_TDMA_BROADCAST_CFG_GROUP_OFFSET 0x100
#define AWS_REG_V2_TDMA_MODEL_TDMA_BROADCAST_CFG_LAST_NODE_OFFSET 0x104
 ...
 *         -EINVAL      - Fail to initialize.
 */
static inline int sdma_configure_broadcast(void __iomem *regs_base, int eng_id)
{
	u16 mask = U16_MAX;
	u16 i;
	u16 clr_bit;
	bool is_last_node;
	u16 last_node;
	void __iomem *base = regs_base + V2_APB_SENG_0_SDMA_0_APP_RELBASE;
	...
	reg_write32(base + AWS_REG_V2_TDMA_MODEL_TDMA_BROADCAST_CFG_GROUP_OFFSET, mask);
	reg_write32(base + AWS_REG_V2_TDMA_MODEL_TDMA_BROADCAST_CFG_LAST_NODE_OFFSET, last_node);
